##------------------------------------------------
## Terragrunt configuration for DigitalOcean Container Registry
##
## Prerequisites:
...
##------------------------------------------------
terraform {
  source = "git::https://github.com/terraform-do-modules/terraform-digitalocean-container-registry.git//?ref=v1.0.0"
